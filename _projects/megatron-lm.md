...
**Figure 2:** (a): MLP and (b): self attention blocks of transformer. **_f_** and **_g_** are conjugate, **_f_** is **identity** operator in the forward pass and **all-reduce** in the backward pass while **_g_** is **all-reduce** in forward and **identity** in backward.
